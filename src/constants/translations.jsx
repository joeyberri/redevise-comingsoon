...
export const translations = {
  en: {
    ...
    modal: {
      ...
      errors: {
        network: "We're having trouble connecting to the network. Please check your internet connection and try again.",
        emailKey: "Our message server is undergoing minor maintenance. Please try scheduling a call directly, or contact us at team@redevise.com.",
        emailFail: "Your message couldn't be sent right now. You can try scheduling a call instead, or email us at team@redevise.com.",
        emailGeneral: "Something went wrong while sending your message. Please try again or reach us at team@redevise.com.",
        bookingSlots: "Our scheduling service is temporarily unavailable. Please send us a message under the 'Send a Message' option, or contact us at team@redevise.com.",
        bookingConfirm: "We couldn't confirm your appointment. Please double-check your booking time or try sending us a message directly.",
      ...
      success: {
        ...
        sent: "Message Sent!",
        bookedSub: "You'll receive a confirmation email shortly. Looking forward to speaking with you!",
        sentSub: "We've got your message and will get back to you as soon as possible."
      },
      panels: {
        bookedTitle: <>You're<br />Booked.</>,
        bookedSub: "Check your inbox for the confirmation details.",
        ...
        touchSub: "We'd love to learn about your project and find the best way to help."
      },
      steps: {
      ...
      sections: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "Interferir con, interrumpir o probar la vulnerabilidad de nuestros servidores, redes o configuraciones de alojamiento.",
