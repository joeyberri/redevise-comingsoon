...
import StepLabel from "../components/estimate/StepLabel.jsx";
import FeatureToggle from "../components/estimate/FeatureToggle.jsx";
import AnimatedPrice from "../components/estimate/AnimatedPrice.jsx";
          ...
          <div className="max-w-3xl">
            ...
            <AnimatePresence mode="wait">
              {scopeLevels[scopeIndex] && (
                  ...
                  className="mt-6 rounded-none border border-text/[0.08] bg-text/[0.02] p-5"
                >
